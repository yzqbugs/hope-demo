import{_ as e}from"./plugin-vue_export-helper.21dcd24c.js";import{o as s,c as n,e as a}from"./app.0b1d8d51.js";const t={},o=a(`<h1 id="footer" tabindex="-1"><a class="header-anchor" href="#footer" aria-hidden="true">#</a> Footer</h1><p>When the <a href="./theme-layout">page layout</a> is set to either <code>home</code> or <code>page</code>, VitePress will display global footer at the bottom of the page. Set <code>themeConfig.footer</code> to configure footer content.</p><div class="language-typescript ext-ts line-numbers-mode"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
