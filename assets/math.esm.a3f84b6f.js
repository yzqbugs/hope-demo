var t = typeof globalThis != "undefined" ? globalThis : typeof window != "undefined" ? window : typeof global != "undefined" ? global : typeof self != "undefined" ? self : {}, e = function(t2) {
  ...
  return this;
}() || Function("return this")(), r = {}, o = function(t2) {
  try {
    return !!t2();
  } catch (t3) {
    return true;
...
}), a = {}, c = {}.propertyIsEnumerable, u = Object.getOwnPropertyDescriptor, f = u && !c.call({ 1: 2 }, 1);
a.f = f ? function(t2) {
  var e2 = u(this, t2);
...
var s = function(t2, e2) {
...
}, l = {}.toString, p = function(t2) {
  return l.call(t2).slice(8, -1);
}, h = p, v = "".split, d = o(function() {
  ...
  return Object(O(t2));
}, S = E, T = {}.hasOwnProperty, P = function(t2, e2) {
  return T.call(S(t2), e2);
}, _ = w, k = n.document, L = _(k) && _(k.createElement), M = function(t2) {
  return L ? k.createElement(t2) : {};
}, A = M, I = !i && !o(function() {
  return Object.defineProperty(A("div"), "a", { get: function() {
    return 7;
  } }).a != 7;
}), R = i, C = a, N = s, F = b, J = x, D = P, $ = I, G = Object.getOwnPropertyDescriptor;
...
var H = {}, z = w, W = function(t2) {
  if (!z(t2))
    throw TypeError(String(t2) + " is not an object");
  return t2;
}, q = i, U = I, K = W, Q = x, X = Object.defineProperty;
...
var Y = H, B = s, V = i ? function(t2, e2, n2) {
  return Y.f(t2, e2, B(1, n2));
} : function(t2, e2, n2) {
  return t2[e2] = n2, t2;
}, Z = { exports: {} }, tt = n, et = V, nt = function(t2, e2) {
  try {
    et(tt, t2, e2);
  } catch (n2) {
    tt[t2] = e2;
  ...
  return e2;
}, rt = nt, ot = n["__core-js_shared__"] || rt("__core-js_shared__", {}), it = ot, at = Function.toString;
typeof it.inspectSource != "function" && (it.inspectSource = function(t2) {
  return at.call(t2);
});
var ct = it.inspectSource, ut = ct, ft = n.WeakMap, st = typeof ft == "function" && /native code/.test(ut(ft)), lt = { exports: {} }, pt = ot;
...
var ht, vt, dt, yt = 0, gt = Math.random(), mt = function(t2) {
  return "Symbol(" + String(t2 === void 0 ? "" : t2) + ")_" + (++yt + gt).toString(36);
}, bt = lt.exports, wt = mt, jt = bt("keys"), xt = function(t2) {
  return jt[t2] || (jt[t2] = wt(t2));
}, Ot = {}, Et = st, St = w, Tt = V, Pt = P, _t = ot, kt = xt, Lt = Ot, Mt = n.WeakMap;
if (Et || _t.state) {
  var At = _t.state || (_t.state = new Mt()), It = At.get, Rt = At.has, Ct = At.set;
  ht = function(t2, e2) {
    if (Rt.call(At, t2))
...
} }, Jt = n, Dt = V, $t = P, Gt = nt, Ht = ct, zt = Ft.get, Wt = Ft.enforce, qt = String(String).split("String");
...
var Ut = n, Kt = n, Qt = function(t2) {
...
}, se = { includes: fe(true), indexOf: fe(false) }, le = P, pe = b, he = se.indexOf, ve = Ot, de = function(t2, e2) {
  ...
  return i2;
}, ye = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"], ge = de, me = ye.concat("length", "prototype");
Yt.f = Object.getOwnPropertyNames || function(t2) {
  return ge(t2, me);
};
var be = {};
be.f = Object.getOwnPropertySymbols;
var we = Yt, je = be, xe = W, Oe = Xt("Reflect", "ownKeys") || function(t2) {
  var e2 = we.f(xe(t2)), n2 = je.f;
  return n2 ? e2.concat(n2(t2)) : e2;
}, Ee = P, Se = Oe, Te = r, Pe = H, _e = o, ke = /#|\.prototype\./, Le = function(t2, e2) {
  var n2 = Ae[Me(t2)];
  return n2 == Re || n2 != Ie && (typeof e2 == "function" ? _e(e2) : !!e2);
}, Me = Le.normalize = function(t2) {
  return String(t2).replace(ke, ".").toLowerCase();
}, Ae = Le.data = {}, Ie = Le.NATIVE = "N", Re = Le.POLYFILL = "P", Ce = Le, Ne = n, Fe = r.f, Je = V, De = Z.exports, $e = nt, Ge = function(t2, e2) {
  for (var n2 = Se(e2), r2 = Pe.f, o2 = Te.f, i2 = 0; i2 < n2.length; i2++) {
    var a2 = n2[i2];
    Ee(t2, a2) || r2(t2, a2, o2(e2, a2));
  }
}, He = Ce, ze = function(t2, e2) {
...
}, We = de, qe = ye, Ue = Object.keys || function(t2) {
  return We(t2, qe);
}, Ke = i, Qe = o, Xe = Ue, Ye = be, Be = a, Ve = E, Ze = d, tn = Object.assign, en = Object.defineProperty, nn = !tn || Qe(function() {
...
var pn, hn, vn = Xt("navigator", "userAgent") || "", dn = vn, yn = n.process, gn = yn && yn.versions, mn = gn && gn.v8;
mn ? hn = (pn = mn.split("."))[0] < 4 ? 1 : pn[0] + pn[1] : dn && (!(pn = dn.match(/Edge\/(\d+)/)) || pn[1] >= 74) && (pn = dn.match(/Chrome\/(\d+)/)) && (hn = pn[1]);
var bn = hn && +hn, wn = bn, jn = o, xn = !!Object.getOwnPropertySymbols && !jn(function() {
  return !String(Symbol()) || !Symbol.sham && wn && wn < 41;
}), On = xn && !Symbol.sham && typeof Symbol.iterator == "symbol", En = n, Sn = lt.exports, Tn = P, Pn = mt, _n = xn, kn = On, Ln = Sn("wks"), Mn = En.Symbol, An = kn ? Mn : Mn && Mn.withoutSetter || Pn, In = function(t2) {
  return Tn(Ln, t2) && (_n || typeof Ln[t2] == "string") || (_n && Tn(Mn, t2) ? Ln[t2] = Mn[t2] : Ln[t2] = An("Symbol." + t2)), Ln[t2];
}, Rn = {};
Rn[In("toStringTag")] = "z";
var Cn = String(Rn) === "[object z]", Nn = Cn, Fn = p, Jn = In("toStringTag"), Dn = Fn(function() {
  return arguments;
}()) == "Arguments", $n = Nn ? Fn : function(t2) {
  var e2, n2, r2;
...
}, Gn = $n, Hn = Cn ? {}.toString : function() {
  return "[object " + Gn(this) + "]";
}, zn = Cn, Wn = Z.exports, qn = Hn;
zn || Wn(Object.prototype, "toString", qn, { unsafe: true });
var Un = n.Promise, Kn = Z.exports, Qn = w, Xn = W, Yn = function(t2) {
  if (!Qn(t2) && t2 !== null)
    throw TypeError("Can't set " + String(t2) + " as a prototype");
  return t2;
}, Bn = Object.setPrototypeOf || ("__proto__" in {} ? function() {
  var t2, e2 = false, n2 = {};
  try {
...
}() : void 0), Vn = H.f, Zn = P, tr = In("toStringTag"), er = Xt, nr = H, rr = i, or = In("species"), ir = function(t2) {
  if (typeof t2 != "function")
    throw TypeError(String(t2) + " is not a function");
  return t2;
}, ar = {}, cr = ar, ur = In("iterator"), fr = Array.prototype, sr = ir, lr = function(t2, e2, n2) {
  if (sr(t2), e2 === void 0)
    return t2;
  switch (n2) {
    case 0:
...
}, pr = $n, hr = ar, vr = In("iterator"), dr = W, yr = W, gr = function(t2) {
  return t2 !== void 0 && (cr.Array === t2 || fr[ur] === t2);
}, mr = ne, br = lr, wr = function(t2) {
  if (t2 != null)
...
}, Or = In("iterator"), Er = false;
try {
  var Sr = 0, Tr = { next: function() {
    return { done: !!Sr++ };
  }, return: function() {
    Er = true;
  } };
...
var Pr, _r, kr, Lr = W, Mr = ir, Ar = In("species"), Ir = Xt("document", "documentElement"), Rr = /(?:iphone|ipod|ipad).*applewebkit/i.test(vn), Cr = p(n.process) == "process", Nr = n, Fr = o, Jr = lr, Dr = Ir, $r = M, Gr = Rr, Hr = Cr, zr = Nr.location, Wr = Nr.setImmediate, qr = Nr.clearImmediate, Ur = Nr.process, Kr = Nr.MessageChannel, Qr = Nr.Dispatch, Xr = 0, Yr = {}, Br = function(t2) {
...
var eo, no, ro, oo, io, ao, co, uo, fo = { set: Wr, clear: qr }, so = /web0s(?!.*chrome)/i.test(vn), lo = n, po = r.f, ho = fo.set, vo = Rr, yo = so, go = Cr, mo = lo.MutationObserver || lo.WebKitMutationObserver, bo = lo.document, wo = lo.process, jo = lo.Promise, xo = po(lo, "queueMicrotask"), Oo = xo && xo.value;
Oo || (eo = function() {
  var t2, e2;
...
var _o, ko, Lo, Mo, Ao = W, Io = w, Ro = So, Co = n, No = typeof window == "object", Fo = ze, Jo = n, Do = Xt, $o = Un, Go = Z.exports, Ho = function(t2, e2, n2) {
  for (var r2 in e2)
    Kn(t2, r2, e2[r2], n2);
  return t2;
}, zo = Bn, Wo = function(t2, e2, n2) {
...
}, Uo = w, Ko = ir, Qo = function(t2, e2, n2) {
  if (!(t2 instanceof e2))
    throw TypeError("Incorrect " + (n2 ? n2 + " " : "") + "invocation");
  return t2;
}, Xo = ct, Yo = function(t2, e2, n2) {
...
}, Zo = fo.set, ti = Eo, ei = function(t2, e2) {
...
}, ri = So, oi = function(t2) {
  try {
    return { error: false, value: t2() };
  } catch (t3) {
    return { error: true, value: t3 };
  }
}, ii = Ft, ai = Ce, ci = No, ui = Cr, fi = bn, si = In("species"), li = "Promise", pi = ii.get, hi = ii.set, vi = ii.getterFor(li), di = $o && $o.prototype, yi = $o, gi = di, mi = Jo.TypeError, bi = Jo.document, wi = Jo.process, ji = ri.f, xi = ji, Oi = !!(bi && bi.createEvent && Jo.dispatchEvent), Ei = typeof PromiseRejectionEvent == "function", Si = false, Ti = ai(li, function() {
...
}, Ri = function(t2, e2, n2) {
  return function(r2) {
    t2(e2, r2, n2);
  };
}, Ci = function(t2, e2, n2) {
...
var Fi, Ji = H, Di = W, $i = Ue, Gi = i ? Object.defineProperties : function(t2, e2) {
  Di(t2);
  for (var n2, r2 = $i(e2), o2 = r2.length, i2 = 0; o2 > i2; )
    Ji.f(t2, n2 = r2[i2++], e2[n2]);
  return t2;
}, Hi = W, zi = Gi, Wi = ye, qi = Ot, Ui = Ir, Ki = M, Qi = xt("IE_PROTO"), Xi = function() {
}, Yi = function(t2) {
...
}, pa = la, ha = Plugin = Object.assign(pa(), { KaTeX: function() {
