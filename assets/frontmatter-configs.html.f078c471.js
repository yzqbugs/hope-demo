...
<span class="token punctuation">---</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,47),l=[i];function o(p,c){return a(),s("div",null,l)}const r=n(t,[["render",o],["__file","frontmatter-configs.html.vue"]]);export{r as default};
