import{_ as t,W as p,X as i,Y as s,Z as n,$ as o,a0 as a,F as l}from"./framework-0d6dbdc9.js";const r={},c=a(`<h1 id="theme-configs" tabindex="-1"><a class="header-anchor" href="#theme-configs" aria-hidden="true">#</a> Theme Configs</h1><p>Theme configs let you customize your theme. You can define theme configs by adding <code>themeConfig</code> key to the config file.</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
