import{_ as e}from"./plugin-vue_export-helper.21dcd24c.js";import{o as t,c as i,a as s,d as o,w as l,b as n,e as c,r as p}from"./app.8cef77d0.js";const u={},r=s("h1",{id:"home-page",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#home-page","aria-hidden":"true"},"#"),n(" Home Page")],-1),d=n("VitePress default theme provides a homepage layout, which you can also see used on "),m=n("the homepage of this site"),v=n(". You may use it on any of your pages by specifying "),k=s("code",null,"layout: home",-1),b=n(" in the "),h=s("a",{href:"./frontmatter"},"frontmatter",-1),g=n("."),y=c(`<div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token punctuation">---</span>
