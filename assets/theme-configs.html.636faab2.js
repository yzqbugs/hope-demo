import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as p,c as i,a as s,b as n,d as o,e as a,r as l}from"./app.11ca791a.js";const r={},c=a(`<h1 id="theme-configs" tabindex="-1"><a class="header-anchor" href="#theme-configs" aria-hidden="true">#</a> Theme Configs</h1><p>Theme configs let you customize your theme. You can define theme configs by adding <code>themeConfig</code> key to the config file.</p><div class="language-typescript ext-ts line-numbers-mode"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8);function k(v,m){const e=l("ExternalLinkIcon");return p(),i("div",null,[c,s("p",null,[n("A option to display "),s("a",d,[n("Carbon Ads"),o(e)]),n(".")]),u])}const h=t(r,[["render",k],["__file","theme-configs.html.vue"]]);export{h as default};
