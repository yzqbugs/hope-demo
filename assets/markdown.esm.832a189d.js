...
var c = typeof globalThis != "undefined" ? globalThis : typeof window != "undefined" ? window : typeof global != "undefined" ? global : typeof self != "undefined" ? self : {}, f = function(e2) {
  return e2 && e2.Math == Math && e2;
}, p = f(typeof globalThis == "object" && globalThis) || f(typeof window == "object" && window) || f(typeof self == "object" && self) || f(typeof c == "object" && c) || function() {
  return this;
}() || Function("return this")(), h = {}, D = function(e2) {
  try {
    return !!e2();
  } catch (e3) {
    return true;
...
}), d = {}, v = {}.propertyIsEnumerable, y = Object.getOwnPropertyDescriptor, A = y && !v.call({ 1: 2 }, 1);
d.f = A ? function(e2) {
  var t2 = y(this, e2);
...
var m = function(e2, t2) {
  ...
  return Object(R(e2));
}, j = I, z = {}.hasOwnProperty, $ = function(e2, t2) {
  return z.call(j(e2), t2);
}, P = _, L = p.document, M = P(L) && P(L.createElement), N = function(e2) {
  return M ? L.createElement(e2) : {};
}, U = N, q = !g && !D(function() {
  return Object.defineProperty(U("div"), "a", { get: function() {
    return 7;
  } }).a != 7;
}), Z = g, G = d, H = m, Q = S, V = O, Y = $, K = q, X = Object.getOwnPropertyDescriptor;
...
var W = {}, J = _, ee = function(e2) {
  if (!J(e2))
    throw TypeError(String(e2) + " is not an object");
  return e2;
}, te = g, ne = q, re = ee, ue = O, ie = Object.defineProperty;
...
var oe = W, ae = m, se = g ? function(e2, t2, n2) {
  return oe.f(e2, t2, ae(1, n2));
} : function(e2, t2, n2) {
  return e2[t2] = n2, e2;
}, le = { exports: {} }, ce = p, fe = se, pe = function(e2, t2) {
  try {
    fe(ce, e2, t2);
  } catch (n2) {
    ce[e2] = t2;
  ...
  return t2;
}, he = pe, De = p["__core-js_shared__"] || he("__core-js_shared__", {}), ge = De, de = Function.toString;
typeof ge.inspectSource != "function" && (ge.inspectSource = function(e2) {
  return de.call(e2);
});
var ve = ge.inspectSource, ye = ve, Ae = p.WeakMap, me = typeof Ae == "function" && /native code/.test(ye(Ae)), ke = { exports: {} }, Ee = De;
...
var xe, Fe, be, Ce = 0, we = Math.random(), Be = function(e2) {
  return "Symbol(" + String(e2 === void 0 ? "" : e2) + ")_" + (++Ce + we).toString(36);
}, Se = ke.exports, _e = Be, Te = Se("keys"), Oe = function(e2) {
  return Te[e2] || (Te[e2] = _e(e2));
}, Re = {}, Ie = me, je = _, ze = se, $e = $, Pe = De, Le = Oe, Me = Re, Ne = p.WeakMap;
if (Ie || Pe.state) {
  var Ue = Pe.state || (Pe.state = new Ne()), qe = Ue.get, Ze = Ue.has, Ge = Ue.set;
  xe = function(e2, t2) {
    if (Ze.call(Ue, e2))
...
} }, Ve = p, Ye = se, Ke = $, Xe = pe, We = ve, Je = Qe.get, et = Qe.enforce, tt = String(String).split("String");
...
var nt = p, rt = p, ut = function(e2) {
...
}, kt = { includes: mt(true), indexOf: mt(false) }, Et = $, xt = S, Ft = kt.indexOf, bt = Re, Ct = function(e2, t2) {
  ...
  return i2;
}, wt = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"], Bt = Ct, St = wt.concat("length", "prototype");
ot.f = Object.getOwnPropertyNames || function(e2) {
  return Bt(e2, St);
};
var _t = {};
_t.f = Object.getOwnPropertySymbols;
var Tt = ot, Ot = _t, Rt = ee, It = it("Reflect", "ownKeys") || function(e2) {
  var t2 = Tt.f(Rt(e2)), n2 = Ot.f;
  return n2 ? t2.concat(n2(e2)) : t2;
}, jt = $, zt = It, $t = h, Pt = W, Lt = D, Mt = /#|\.prototype\./, Nt = function(e2, t2) {
  var n2 = qt[Ut(e2)];
  return n2 == Gt || n2 != Zt && (typeof t2 == "function" ? Lt(t2) : !!t2);
}, Ut = Nt.normalize = function(e2) {
  return String(e2).replace(Mt, ".").toLowerCase();
}, qt = Nt.data = {}, Zt = Nt.NATIVE = "N", Gt = Nt.POLYFILL = "P", Ht = Nt, Qt = p, Vt = h.f, Yt = se, Kt = le.exports, Xt = pe, Wt = function(e2, t2) {
  for (var n2 = zt(t2), r2 = Pt.f, u2 = $t.f, i2 = 0; i2 < n2.length; i2++) {
    var o2 = n2[i2];
    jt(e2, o2) || r2(e2, o2, u2(t2, o2));
  }
}, Jt = Ht, en = function(e2, t2) {
...
var an = nn, sn = rn, ln = ke.exports, cn = RegExp.prototype.exec, fn = ln("native-string-replace", String.prototype.replace), pn = cn, hn = function() {
  var e2 = /a/, t2 = /b*/g;
  return cn.call(e2, "a"), cn.call(t2, "a"), e2.lastIndex !== 0 || t2.lastIndex !== 0;
}(), Dn = sn.UNSUPPORTED_Y || sn.BROKEN_CARET, gn = /()??/.exec("")[1] !== void 0;
...
var vn, yn, An = it("navigator", "userAgent") || "", mn = An, kn = p.process, En = kn && kn.versions, xn = En && En.v8;
xn ? yn = (vn = xn.split("."))[0] < 4 ? 1 : vn[0] + vn[1] : mn && (!(vn = mn.match(/Edge\/(\d+)/)) || vn[1] >= 74) && (vn = mn.match(/Chrome\/(\d+)/)) && (yn = vn[1]);
var Fn = yn && +yn, bn = Fn, Cn = D, wn = !!Object.getOwnPropertySymbols && !Cn(function() {
  return !String(Symbol()) || !Symbol.sham && bn && bn < 41;
}), Bn = wn && !Symbol.sham && typeof Symbol.iterator == "symbol", Sn = p, _n = ke.exports, Tn = $, On = Be, Rn = wn, In = Bn, jn = _n("wks"), zn = Sn.Symbol, $n = In ? zn : zn && zn.withoutSetter || On, Pn = function(e2) {
  return Tn(jn, e2) && (Rn || typeof jn[e2] == "string") || (Rn && Tn(zn, e2) ? jn[e2] = zn[e2] : jn[e2] = $n("Symbol." + e2)), jn[e2];
}, Ln = le.exports, Mn = dn, Nn = D, Un = Pn, qn = se, Zn = Un("species"), Gn = RegExp.prototype, Hn = !Nn(function() {
  var e2 = /./;
  return e2.exec = function() {
    var e3 = [];
    return e3.groups = { a: "7" }, e3;
  }, "".replace(e2, "$<a>") !== "7";
}), Qn = "a".replace(/./, "$0") === "$0", Vn = Un("replace"), Yn = !!/./[Vn] && /./[Vn]("a", "$0") === "", Kn = !Nn(function() {
  var e2 = /(?:)/, t2 = e2.exec;
  e2.exec = function() {
...
}, tr = { codeAt: er(false), charAt: er(true) }, nr = tr.charAt, rr = function(e2, t2, n2) {
  return t2 + (n2 ? nr(e2, t2).length : 1);
}, ur = I, ir = Math.floor, or = "".replace, ar = /\$([$&'`]|\d{1,2}|<[^>]*>)/g, sr = /\$([$&'`]|\d{1,2})/g, lr = E, cr = dn, fr = function(e2, t2) {
  var n2 = e2.exec;
...
}, pr = Xn, hr = ee, Dr = pt, gr = lt, dr = C, vr = rr, yr = function(e2, t2, n2, r2, u2, i2) {
...
}() : void 0), Cr = _, wr = br, Br = _, Sr = E, _r = Pn("match"), Tr = function(e2) {
  var t2;
  return Br(e2) && ((t2 = e2[_r]) !== void 0 ? !!t2 : Sr(e2) == "RegExp");
}, Or = it, Rr = W, Ir = g, jr = Pn("species"), zr = function(e2) {
  var t2 = Or(e2), n2 = Rr.f;
  Ir && t2 && !t2[jr] && n2(t2, jr, { configurable: true, get: function() {
    return this;
  } });
}, $r = g, Pr = p, Lr = Ht, Mr = function(e2, t2, n2) {
  var r2, u2;
  return wr && typeof (r2 = t2.constructor) == "function" && r2 !== n2 && Cr(u2 = r2.prototype) && u2 !== n2.prototype && wr(e2, u2), e2;
}, Nr = W.f, Ur = ot.f, qr = Tr, Zr = nn, Gr = rn, Hr = le.exports, Qr = D, Vr = Qe.enforce, Yr = zr, Kr = Pn("match"), Xr = Pr.RegExp, Wr = Xr.prototype, Jr = /a/g, eu = /a/g, tu = new Xr(Jr) !== Jr, nu = Gr.UNSUPPORTED_Y;
if ($r && Lr("RegExp", !tu || nu || Qr(function() {
  return eu[Kr] = false, Xr(Jr) != Jr || Xr(eu) == eu || Xr(Jr, "i") != "/a/i";
}))) {
  for (var ru = function(e2, t2) {
...
Yr("RegExp");
var au = le.exports, su = ee, lu = D, cu = nn, fu = RegExp.prototype, pu = fu.toString, hu = lu(function() {
...
var gu = ee, du = pt, vu = C, yu = rr, Au = fr;
...
var mu = g, ku = W.f, Eu = Function.prototype, xu = Eu.toString, Fu = /^\s*function ([^ (]*)/;
...
}, wu = en, Bu = S, Su = [].join, _u = b != Object, Tu = Cu("join", ",");
...
var Ou = function(e2) {
  ...
  return e2;
}, Ru = ee, Iu = Ou, ju = Pn("species"), zu = function(e2, t2) {
  var n2, r2 = Ru(e2).constructor;
  return r2 === void 0 || (n2 = Ru(r2)[ju]) == null ? t2 : Iu(n2);
}, $u = Xn, Pu = Tr, Lu = ee, Mu = C, Nu = zu, Uu = rr, qu = pt, Zu = fr, Gu = dn, Hu = rn.UNSUPPORTED_Y, Qu = [].push, Vu = Math.min;
...
var Yu = C, Ku = "[	\n\v\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF]", Xu = RegExp("^" + Ku + Ku + "*"), Wu = RegExp(Ku + Ku + "*$"), Ju = function(e2) {
  return function(t2) {
    var n2 = String(Yu(t2));
    return 1 & e2 && (n2 = n2.replace(Xu, "")), 2 & e2 && (n2 = n2.replace(Wu, "")), n2;
  };
}, ei = { start: Ju(1), end: Ju(2), trim: Ju(3) }, ti = D, ni = "	\n\v\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF", ri = function(e2) {
  return ti(function() {
...
}, si = E, li = Array.isArray || function(e2) {
  return si(e2) == "Array";
}, ci = _, fi = li, pi = Pn("species"), hi = function(e2, t2) {
  var n2;
...
}, Di = ai, gi = b, di = I, vi = pt, yi = hi, Ai = [].push, mi = function(e2) {
...
}, ki = { forEach: mi(0), map: mi(1), filter: mi(2), some: mi(3), every: mi(4), find: mi(5), findIndex: mi(6), filterOut: mi(7) }, Ei = ki.forEach, xi = p, Fi = ii, bi = Cu("forEach") ? [].forEach : function(e2) {
  return Ei(this, e2, arguments.length > 1 ? arguments[1] : void 0);
}, Ci = se;
for (var wi in Fi) {
  var Bi = xi[wi], Si = Bi && Bi.prototype;
  if (Si && Si.forEach !== bi)
    try {
      Ci(Si, "forEach", bi);
    } catch (e2) {
...
var _i = {};
_i[Pn("toStringTag")] = "z";
var Ti = String(_i) === "[object z]", Oi = Ti, Ri = E, Ii = Pn("toStringTag"), ji = Ri(function() {
  return arguments;
}()) == "Arguments", zi = Oi ? Ri : function(e2) {
  var t2, n2, r2;
...
}, $i = zi, Pi = Ti ? {}.toString : function() {
  return "[object " + $i(this) + "]";
}, Li = Ti, Mi = le.exports, Ni = Pi;
Li || Mi(Object.prototype, "toString", Ni, { unsafe: true });
var Ui = p.Promise, qi = le.exports, Zi = W.f, Gi = $, Hi = Pn("toStringTag"), Qi = function(e2, t2, n2) {
  e2 && !Gi(e2 = n2 ? e2 : e2.prototype, Hi) && Zi(e2, Hi, { configurable: true, value: t2 });
}, Vi = {}, Yi = Vi, Ki = Pn("iterator"), Xi = Array.prototype, Wi = zi, Ji = Vi, eo = Pn("iterator"), to = ee, no = ee, ro = function(e2) {
  return e2 !== void 0 && (Yi.Array === e2 || Xi[Ki] === e2);
}, uo = pt, io = ai, oo = function(e2) {
  if (e2 != null)
...
}, lo = Pn("iterator"), co = false;
try {
  var fo = 0, po = { next: function() {
    return { done: !!fo++ };
  }, return: function() {
    co = true;
  } };
...
var ho, Do, go, vo = it("document", "documentElement"), yo = /(?:iphone|ipod|ipad).*applewebkit/i.test(An), Ao = E(p.process) == "process", mo = p, ko = D, Eo = ai, xo = vo, Fo = N, bo = yo, Co = Ao, wo = mo.location, Bo = mo.setImmediate, So = mo.clearImmediate, _o = mo.process, To = mo.MessageChannel, Oo = mo.Dispatch, Ro = 0, Io = {}, jo = function(e2) {
...
var Lo, Mo, No, Uo, qo, Zo, Go, Ho, Qo = { set: Bo, clear: So }, Vo = /web0s(?!.*chrome)/i.test(An), Yo = p, Ko = h.f, Xo = Qo.set, Wo = yo, Jo = Vo, ea = Ao, ta = Yo.MutationObserver || Yo.WebKitMutationObserver, na = Yo.document, ra = Yo.process, ua = Yo.Promise, ia = Ko(Yo, "queueMicrotask"), oa = ia && ia.value;
oa || (Lo = function() {
  var e2, t2;
...
var fa, pa, ha, Da, ga = ee, da = _, va = sa, ya = p, Aa = typeof window == "object", ma = en, ka = p, Ea = it, xa = Ui, Fa = le.exports, ba = function(e2, t2, n2) {
  for (var r2 in t2)
    qi(e2, r2, t2[r2], n2);
  return e2;
}, Ca = br, wa = Qi, Ba = zr, Sa = _, _a = Ou, Ta = function(e2, t2, n2) {
  if (!(e2 instanceof t2))
    throw TypeError("Incorrect " + (n2 ? n2 + " " : "") + "invocation");
  return e2;
}, Oa = ve, Ra = function(e2, t2, n2) {
  ...
  return n2;
}, ja = zu, za = Qo.set, $a = aa, Pa = function(e2, t2) {
...
}, Ma = sa, Na = function(e2) {
  try {
    return { error: false, value: e2() };
  } catch (e3) {
    return { error: true, value: e3 };
  }
}, Ua = Qe, qa = Ht, Za = Aa, Ga = Ao, Ha = Fn, Qa = Pn("species"), Va = "Promise", Ya = Ua.get, Ka = Ua.set, Xa = Ua.getterFor(Va), Wa = xa && xa.prototype, Ja = xa, es = Wa, ts = ka.TypeError, ns = ka.document, rs = ka.process, us = Ma.f, is = us, os = !!(ns && ns.createEvent && ka.dispatchEvent), as = typeof PromiseRejectionEvent == "function", ss = false, ls = qa(Va, function() {
...
var ms = O, ks = W, Es = m, xs = function(e2, t2, n2) {
  var r2 = ms(t2);
  r2 in e2 ? ks.f(e2, r2, Es(0, n2)) : e2[r2] = n2;
}, Fs = D, bs = Fn, Cs = Pn("species"), ws = function(e2) {
...
}, Bs = en, Ss = _, _s = li, Ts = dt, Os = pt, Rs = S, Is = xs, js = Pn, zs = ws("slice"), $s = js("species"), Ps = [].slice, Ls = Math.max;
...
var Ms, Ns = Ct, Us = wt, qs = Object.keys || function(e2) {
  return Ns(e2, Us);
}, Zs = W, Gs = ee, Hs = qs, Qs = g ? Object.defineProperties : function(e2, t2) {
  Gs(e2);
  for (var n2, r2 = Hs(t2), u2 = r2.length, i2 = 0; u2 > i2; )
    Zs.f(e2, n2 = r2[i2++], t2[n2]);
  return e2;
}, Vs = ee, Ys = Qs, Ks = wt, Xs = Re, Ws = vo, Js = N, el = Oe("IE_PROTO"), tl = function() {
}, nl = function(e2) {
...
}, il = ul, ol = W, al = Pn("unscopables"), sl = Array.prototype;
sl[al] == null && ol.f(sl, al, { configurable: true, value: il(null) });
var ll, cl, fl, pl = function(e2) {
  sl[al][e2] = true;
}, hl = !D(function() {
  function e2() {
  }
  return e2.prototype.constructor = null, Object.getPrototypeOf(new e2()) !== e2.prototype;
}), Dl = $, gl = I, dl = hl, vl = Oe("IE_PROTO"), yl = Object.prototype, Al = dl ? Object.getPrototypeOf : function(e2) {
...
}, ml = D, kl = Al, El = se, xl = $, Fl = Pn("iterator"), bl = false;
...
var Cl = { IteratorPrototype: ll, BUGGY_SAFARI_ITERATORS: bl }, wl = Cl.IteratorPrototype, Bl = ul, Sl = m, _l = Qi, Tl = Vi, Ol = function() {
  return this;
}, Rl = en, Il = function(e2, t2, n2) {
  var r2 = t2 + " Iterator";
  return e2.prototype = Bl(wl, { next: Sl(1, n2) }), _l(e2, r2, false), Tl[r2] = Ol, e2;
}, jl = Al, zl = br, $l = Qi, Pl = se, Ll = le.exports, Ml = Vi, Nl = Cl.IteratorPrototype, Ul = Cl.BUGGY_SAFARI_ITERATORS, ql = Pn("iterator"), Zl = function() {
  return this;
}, Gl = function(e2, t2, n2, r2, u2, i2, o2) {
  Il(n2, t2, r2);
  ...
  return s2;
}, Hl = S, Ql = pl, Vl = Vi, Yl = Qe, Kl = Gl, Xl = Yl.set, Wl = Yl.getterFor("Array Iterator"), Jl = Kl(Array, "Array", function(e2, t2) {
...
var ec = tr.charAt, tc = Qe, nc = Gl, rc = tc.set, uc = tc.getterFor("String Iterator");
...
var ic = p, oc = ii, ac = Jl, sc = se, lc = Pn, cc = lc("iterator"), fc = lc("toStringTag"), pc = ac.values;
for (var hc in oc) {
  var Dc = ic[hc], gc = Dc && Dc.prototype;
  if (gc) {
    if (gc[cc] !== pc)
      try {
        sc(gc, cc, pc);
...
var vc = en, yc = D, Ac = li, mc = _, kc = I, Ec = pt, xc = xs, Fc = hi, bc = ws, Cc = Fn, wc = Pn("isConcatSpreadable"), Bc = Cc >= 51 || !yc(function() {
  var e2 = [];
  return e2[wc] = false, e2.concat()[0] !== e2;
}), Sc = bc("concat"), _c = function(e2) {
  if (!mc(e2))
    return false;
  var t2 = e2[wc];
...
var Tc = en, Oc = dt, Rc = lt, Ic = pt, jc = I, zc = hi, $c = xs, Pc = ws("splice"), Lc = Math.max, Mc = Math.min;
...
var Uc = en, qc = ei.start, Zc = ri("trimStart"), Gc = Zc ? function() {
  return qc(this);
} : "".trimStart;
...
var Xc = en, Wc = ei.end, Jc = ri("trimEnd"), ef = Jc ? function() {
  return Wc(this);
} : "".trimEnd;
...
var nf = C, rf = /"/g, uf = D, of = function(e2, t2, n2, r2) {
...
var vf = /[&<>"']/, yf = /[&<>"']/g, Af = /[<>"']|&(?!#?\w+;)/, mf = /[<>"']|&(?!#?\w+;)/g, kf = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, Ef = function(e2) {
  return kf[e2];
};
function xf(e2, t2) {
  if (t2) {
...
export { markdown_esm as default };
